...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_film) {
            fragment = new NewsFilmFragmant();
            setTitle(R.string.fim);
        } else if (id == R.id.nav_sport) {
            fragment = new NewsSportFragmant();
            setTitle(R.string.sport);

        } else if (id == R.id.nav_politics) {
            fragment = new NewsPoliticsFragmant();
            setTitle(R.string.politics);

        } else if (id == R.id.nav_environ) {
            fragment = new NewsEnvironmentFragmant();
            setTitle(R.string.environment);

        } else if (id == R.id.nav_mediatv) {
            fragment = new NewsMediaFragmant();
            setTitle(R.string.media);

        } else if (id == R.id.nav_football) {
            fragment = new NewsFootBallFragmant();
            setTitle(R.string.football);
        } else if (id == R.id.nav_country) {
            fragment = new NewsCountryFragmant();
